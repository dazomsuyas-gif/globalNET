...
export default function SuccessPage() {
  return (
    <section className="min-h-screen py-24 flex items-center justify-center bg-gradient-to-br from-emerald-500/10 via-green-500/5 to-emerald-500/20">
      <Suspense fallback={
        <div className="glass-card max-w-4xl w-full p-16 text-center rounded-3xl">
          <div className="w-32 h-32 mx-auto mb-12 bg-gradient-to-r from-emerald-400 to-green-500 rounded-3xl flex items-center justify-center shadow-2xl">
            <div className="text-4xl text-emerald-900 font-bold">✓</div>
          </div>
          <h1 className="text-6xl font-bold text-white mb-8">Loading...</h1>
        </div>
      }>
        <SuccessContent />
      </Suspense>
